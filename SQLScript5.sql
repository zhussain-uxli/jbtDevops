/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs002]
Description: This is a tmp table for Currencies
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs002];

CREATE TABLE [acq101].[tmp_tcmcs002]
(
	[brep] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom000]
Description: This is a tmp table for Companies
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom000];

CREATE TABLE [acq101].[tmp_tccom000]
(
	[acfg] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs065]
Description: This is a tmp table for Departments
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs065];

CREATE TABLE [acq101].[tmp_tcmcs065]
(
	[cadr] [varchar](9) NULL,
	[cadr_ref_compnr] [varchar](10) NULL,
	[casi] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs010]
Description: This is a tmp table for Countries
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs010];

CREATE TABLE [acq101].[tmp_tcmcs010]
(
	[afal] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom180]
Description: This is a tmp table for Country Set
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom180];

CREATE TABLE [acq101].[tmp_tccom180]
(
	[compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom181]
Description: This is a tmp table for Countries by Country Set
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom181];

CREATE TABLE [acq101].[tmp_tccom181]
(
	[ccty] [varchar](3) NULL,
	[ccty_ref_compnr] [varchar](10) NULL,
	[compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom130]
Description: This is a tmp table for Address
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom130];

CREATE TABLE [acq101].[tmp_tccom130]
(
	[afal] [varchar](3) NULL,
	[afal_ref_compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom100]
Description: This is a tmp table for Business_Partner
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom100];

CREATE TABLE [acq101].[tmp_tccom100]
(
	[beid] [varchar](255) NULL,
	[bpid] [varchar](9) NULL,
	[bprl] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom112]
Description: This is a tmp table for Invoice-to Business partners
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom112];

CREATE TABLE [acq101].[tmp_tccom112]
(
	[adam] [float] NULL,
	[adpc] [float] NULL,
	[bicy] [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom122]
Description: This is a tmp table for Invoice-from Business partners
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tccom122];

CREATE TABLE [acq101].[tmp_tccom122]
(
	bloc [varchar](3) NULL,
	bpcl [varchar](12) NULL,
	bpcl_ref_compnr [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom110]
Description: This is a tmp table for Sold-to Business Partners
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom110];

CREATE TABLE [acq101].[tmp_tccom110]
(
	[aalg] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom111]
Description: This is a tmp table for Ship-to Business Partners
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom111];

CREATE TABLE [acq101].[tmp_tccom111]
(
	[aetc] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom114]
Description: This is a tmp table for Pay-by Business Partners
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tccom114];

CREATE TABLE [acq101].[tmp_tccom114]
(
	aofc [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom124]
Description: This is a tmp table for Pay-to Business Partners
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tccom124];

CREATE TABLE [acq101].[tmp_tccom124]
(
	aofc [varchar](6) NULL,
	aofc_ref_compnr [varchar](10) NULL,
	bank [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom120]
Description: This is a tmp table for Buy-from Business Partners
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tccom120];

CREATE TABLE [acq101].[tmp_tccom120]
(
	ackx [int] NULL,
	ackx_kw [varchar](255) NULL,
	afrb [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom121]
Description: This is a tmp table for Ship-from Business Partners
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tccom121];

CREATE TABLE [acq101].[tmp_tccom121]
(
	bpst [int] NULL,
	bpst_kw [varchar](255) NULL,
	cadr [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs013]
Description: This is a tmp table for PaymentTerms
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs013];

CREATE TABLE [acq101].[tmp_tcmcs013]
(
	[atie] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs062]
Description: This is a tmp table for Product Classes
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs062];

CREATE TABLE [acq101].[tmp_tcmcs062]
(
	[compnr] [varchar](10) NULL,
	[cpcl] [varchar](6) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs061]
Description: This is a tmp table for Product Lines
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs061];

CREATE TABLE [acq101].[tmp_tcmcs061]
(
	[compnr] [varchar](10) NULL,
	[cpln] [varchar](6) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs015]
Description: This is a tmp table for  Product Types
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs015];

CREATE TABLE [acq101].[tmp_tcmcs015]
(
	[compnr] [varchar](10) NULL,
	[ctyp] [varchar](3) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcibd001]
Description: This is a tmp table for Items
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcibd001];

CREATE TABLE [acq101].[tmp_tcibd001]
(
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tctax016]
Description: This is a tmp table for Tax Clasification
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tctax016];

CREATE TABLE [acq101].[tmp_tctax016]
(
	[bpcl] [varchar](12) NULL,
	[compnr] [varchar](10) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs031]
Description: This is a tmp table for Lines_of_Business
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs031];

CREATE TABLE [acq101].[tmp_tcmcs031]
(
	[cbrn] [varchar](6) NULL,
	[compnr] [varchar](10) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs080]
Description: This is a tmp table for Carriers_LSP
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs080];

CREATE TABLE [acq101].[tmp_tcmcs080]
(
	[cfrw] [varchar](3) NULL,
	[compnr] [varchar](10) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdsls012]
Description: This is a tmp table for Sales_Office
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tdsls012];

CREATE TABLE [acq101].[tmp_tdsls012]
(
	[cofc] [varchar](6) NULL,
	[cofc_ref_compnr] [varchar](10) NULL,
	[compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdpur012]
Description: This is a tmp table for Purchase Office
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tdpur012];

CREATE TABLE [acq101].[tmp_tdpur012]
(
	cofc [varchar](6) NULL,
	cofc_ref_compnr [varchar](10) NULL,
	compnr [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs003]
Description: This is a tmp table for Warehouses
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs003];

CREATE TABLE [acq101].[tmp_tcmcs003]
(
	[bpid] [varchar](9) NULL,
	[cadr] [varchar](9) NULL,
	[cadr_ref_compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tccom001]
Description: This is a tmp table for Employees_General
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tccom001];

CREATE TABLE [acq101].[tmp_tccom001]
(
	[ccal] [varchar](9) NULL,
	[ccal_ref_compnr] [varchar](10) NULL,
	[clan] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs042]
Description: This is a tmp table for Point of Title Passage
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs042];

CREATE TABLE [acq101].[tmp_tcmcs042]
(
	[cadr] [varchar](9) NULL,
	[cadr_ref_compnr] [varchar](10) NULL,
	[compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs005]
Description: This is a tmp table for Reasons
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs005];

CREATE TABLE [acq101].[tmp_tcmcs005]
(
	[appr] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdsls094]
Description: This is a tmp table for Sales_Order_Types
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tdsls094];

CREATE TABLE [acq101].[tmp_tdsls094]
(
	[aaps] [int] NULL,
	[aaps_kw] [varchar](255) NULL,
	[aprd] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdsls097]
Description: This is a tmp table for Change_Reasons
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tdsls097];

CREATE TABLE [acq101].[tmp_tdsls097]
(
	[compnr] [varchar](10) NULL,
	[crcd] [varchar](6) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs202]
Description: This is a tmp table for Sales_Type
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs202];

CREATE TABLE [acq101].[tmp_tcmcs202]
(
	[cfrs] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs036]
Description: This is a tmp table for Tax Codes
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs036];

CREATE TABLE [acq101].[tmp_tcmcs036]
(
	[agtx] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs041]
Description: This is a tmp table for Delivery_Terms
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcmcs041];

CREATE TABLE [acq101].[tmp_tcmcs041]
(
	[cdec] [varchar](3) NULL,
	[cdyn] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfcmg003]
Description: This is a tmp table for Payment Method
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tfcmg003];

CREATE TABLE [acq101].[tmp_tfcmg003]
(
	[adbp] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdpct001]
Description: This is a tmp table for Category
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tdpct001];

CREATE TABLE [acq101].[tmp_tdpct001]
(
	[catc] [varchar](6) NULL,
	[compnr] [varchar](10) NULL,
	[ctyp] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdpct002]
Description: This is a tmp table for Category Structure
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tdpct002];

CREATE TABLE [acq101].[tmp_tdpct002]
(
	[catc] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whwmd215]
Description: This is a tmp table for Item_Inventory_by_Warehouse
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_whwmd215];

CREATE TABLE [acq101].[tmp_whwmd215]
(
	[compnr] [varchar](10) NULL,
	[cwar] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whinr110]
Description: This is a tmp table for Items Transactions by Item and Warehouse
Data Type: TRANSACTION Data
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_whinr110];

CREATE TABLE [acq101].[tmp_whinr110]
(
	[bfbp] [varchar](9) NULL,
	[boml] [int] NULL,
	[bpid] [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcemm050]
Description: This is a tmp table for Sites
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tcemm050];

CREATE TABLE [acq101].[tmp_tcemm050]
(
	admo [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcibd150]
Description: This is a tmp table for Items data for product classification into purchasing and manufacturing categories..
Data Type: TRANSACTION Data
Original Project: JBT Sales
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [acq101].[tmp_tcibd150];

CREATE TABLE [acq101].[tmp_tcibd150]
(
	[ccde] [varchar](25) NULL,
	[ccde_ref_compnr] [varchar](10) NULL,
	[cean] [varchar](14) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whwmd200]
Description: This is a tmp table for Warehouses
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_whwmd200];

CREATE TABLE [acq101].[tmp_whwmd200]
(
	aipd [int] NULL,
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_enum];

CREATE TABLE [acq101].[tmp_enum]
(
	const 			[int] NULL,
	deleted 		[varchar](10) NULL,
	description 	[varchar](255) NULL,
	zdomain 		[varchar](14)NULL,
	keyword 		[varchar](30)NULL,
	zlanguage 		[varchar](5)NULL,
	sequencenumber 	[int] NULL,
	ztimestamp    	[datetime] NULL,
	username 	  	[varchar](8) NULL,
	file_name 	  	[varchar](100) NOT NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tdipu081]
Description: This is a tmp table for Item - Purchase by Site or Purchase Office
...
--DROP TABLE [acq101].[tmp_tdipu081];

CREATE TABLE [acq101].[tmp_tdipu081] 
(
	acci [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_cprpd100]
Description: This is a Temp table for Items - Planning
...
--DROP TABLE [acq101].[tmp_cprpd100];

CREATE TABLE [acq101].[tmp_cprpd100]
(
	atho [int] NULL,
	atta [float] NULL,
	attm [float] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcibd003]
Description: This is a Temp table for Conversion Factors
...
--DROP TABLE [acq101].[tmp_tcibd003];

CREATE TABLE [acq101].[tmp_tcibd003]
(
	appr [int] NULL,
	appr_kw [varchar](255) NULL,
	basu [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whwmd404]
...
--DROP TABLE [acq101].[tmp_whwmd404];

CREATE TABLE [acq101].[tmp_whwmd404] 
(
	abcc [varchar](1) NULL,
	acoa [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whwmd216]
...
--DROP TABLE [acq101].[tmp_whwmd216];

CREATE TABLE [acq101].[tmp_whwmd216] 
(
	compnr [varchar](10) NULL,
	cwar [varchar](6) NULL,
	cwar_item_ref_compnr [varchar](10) NULL,
