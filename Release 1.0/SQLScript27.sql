/**********************************************************************************************************************
Stored Procedure Name: [replncss].[SP_11_fct_History_Sales_Revenue_Cube]
...
Data Type: Fact Data
Source Table / View: [replncss].[fct History Sales Revenue]
Target Table: [replncss].[fct History Sales Revenue Cube]
...
Dt:19/07/2021
Added new filed "[Reporting Date]". For Invoice Lines "[Delivery Date]" is mapped & for History Sales Order "[SO Transaction Date]" is mapped to populate data into [Reporting Date] field.

Dt:02/08/2021
Added new fields from Warehouse dim View as per Business requirement (i.e.Blocked for Inbound and Outbound fields).

Dt:05/08/2021
Added New fields (Ship-to Address Desc,Sold-to Address Desc), data in these fields is populated from Address dst table (tccom130) which are required for Reporting.
Added New field History Action from the sales order history table(tdsls451).
...
**********************************************************************************************************************/
--EXEC [replncss].[SP_11_fct_History_Sales_Revenue_Cube];

--DROP PROCEDURE [replncss].[SP_11_fct_History_Sales_Revenue_Cube]

CREATE PROCEDURE [replncss].[SP_11_fct_History_Sales_Revenue_Cube]
AS
BEGIN
	SET NOCOUNT ON;
	...
	Delete [replncss].[fct History Sales Revenue Cube];
	
	Insert into [replncss].[fct History Sales Revenue Cube] ([Line Disc Amt],[SO Blocked],[Canceled],[Contract],[Cust Order],[Change Reason],[BackOrd UoM],[Warehouse],[Plnd Deliv Date],[Init Req Date],[Cust Req Date],[Orig Deliv Date],[SO Order Date],[Sales Lines],[Plnd Receipt Date],[Price],[SO Delivered Qty],[Ordered Qty],[Exch Rate Type],[Ship Constraint],[Supply-from Whs],[So Shipment],[Line Sequence],[Ship-to Whs],[Ext Sales Rep],[Return Reason],[Sales Ord Type],[Reference A],[Sales Price List],[Plan Deliv Date],[Installments],[Cost Serv Cont],[Cost FCO],[Cost SO Inv],[Activity Line],[Cost Goodwill],[Act Unit Cost],[Cost Quote],[Actual Line],[Cost Warranty],[Actual Cum Qty],[Actual Del Tme],[Total Cost],[Ord Disc Amt],[Act Purch Amt],[Sales Serv Con],[Total Disc Amt],[Sales FCO],[Sales SO Inv],[Sales Goodwill],[Sales Amt Quote],[Total Sales Amt],[Sales Warranty],[MC Blocked],[Tax Classif],[Delivery Terms],[Discount Code],[Carrier],[Cost Line Stat],[Company number],[Contr Converage],[Sales Price Unit],[Sales Qty Unit],[Delivery Code],[SO Discount],[Delivery Type],[Est Unit Cost],[Service Est Qty],[Service Est Cost Line],[Est Sales Price],[Items],[MC Residual Value],[Discount Amt],[Other Lines],[Service Order],[Activity],[Material or Maintenance Items],[Price Origin],[Sales Price],[PoTP],[Required Qty],[Cost Repair War],[Sales Repair War],[Repair Warranty],[Ship Matl To],[Line of Business],[Payment Terms],[Sales Rep],[Financial Dept],[Invoice-to Addr],[Invoice-to BP],[Sold-to Address],[Sold-to BP],[Payment Method],[Rate Type],[SvcO Cost Sheet],[Act Order Amt],[SOC Cancel Date],[Coverage Type],[Currency],[Serv Contract],[Service Type],[Service Office],[Est Order Amt],[Pricing Method],[Plan Start Time],[Warranty Type],[Act Cost Rate],[Labor Type Cost],[Labor Rate Code],[Task],[Service Discount],[Est Cost rate],[Labor Est Qty],[Sales Inv Amt],[Sales Inv Date],[Labor Type Sales],[Service Warranty],[Cost Amt War],[Actual Qty],[Cost Type],[Unit],[Est Cost Line Id],[Other Costs Items],[Act Receipt Time],[Maint SO],[Planned Carrier 1],[Item Delivery],[MO Delivered Qty],[Delivery Whse],[MO Line Status],[Order Discount],[Non SO Plan Deliv Date],[Plan Rec Time],[Qty],[Actual Carrier],[Planned Carrier 2],[Received Qty],[Shipment],[Receipt Whse],[Ship-to Address],[Ship-to BP],[Sales Type],[Work Order Num],[MO Warranty],[Desc],[Installment Plan],[MO Order Date],[MO Order Status],[Amt Dom Curr],[Net Amt],[Tax Code],[Manual Sales ID],[Manual Lines],[Financial Comp],[Tax Amt Dom],[Department],[Approved Amt],[Approval Action],[Approved By],[Approval Desci],[Approval Date],[Approval Percent],[Claim],[Claimed Amt],[Claim Method],[Appr Qty Unit],[Claim Qty Unit],[CC Residual Value],[Sales Doc Line],[Sales Doc Seq],[Approved Qty],[Claimed Qty],[Reject Action],[Rejected By],[Rejection Date],[Reject Reasons],[Return Matl Req],[CC Line Status],[Tagged To],[Wait Supp Claim],[CC Cancel Date],[Creation Date],[Failure Date],[Int Sales Rep],[Sales Inv Comp],[Sales Doc Num],[Sales Doc Type],[Sales Ref Sys],[Created by],[Order Number],[Order Line Numb],[Table Desc],[Table Shortcode],[Remain Order Qty],[Order Value Due],[NetLineAmt Dom],[Delivery Note],[Invoice Number],[Produc Relation],[Shipment Line],[Source Type],[Time of Action],[Inv Trans Type],[INV Delivered Qty],[Inv Line Seq],[Area],[Carrier/LSP Desc],[Deleted Record],[Carrier Alpha Code],[Buy-from Business Partner],[Transport Category],[Transport Category Desc],[Change Reason Desc],[Last Inventory Transaction Date],[Inventory Allocated],[Inventory Blocked],[Inventory Blocked for Planning],[Consignment Inventory Location Allocated],[Consignment Inventory on Hand],[Cumulative Issue],[Consignment Inventory in Transit],[Inventory Committed],[Consignment on Order],[Inventory Committed in Process],[Consigned Quarantine],[Goods in Transit],[Historical Balance],[Inventory on Hand],[Company Owned Quarantine Inventory],[Inventory in Transit],[Inventory Location Allocated],[Cust Owned Location Allocated],[Cust Owned Blocked],[Cust Owned Blocked for Planning],[Cust Owned on Hand],[Cust Owned in Transit],[Cust Owned on Order],[Cust Owned Quarantine],[Comp Owned Location Allocated],[Comp Owned on Order],[Inventory on Order],[Items Desc],[Item Group],[Product Class],[Product Line],[Item Signal],[Country of Origin],[Product Type],[Inventory Unit],[Serialized],[Default Supply Source],[Line of Business Desc],[Sales Office Desc],[Site],[Sales Order Type Desc],[Ship-to Address Code],[Ship-to Country],[Ship-to Country Name],[Ship-to BP Name],[Sold-to Address Code],[Sold-to Country],[Sold-to Country Name],[Sold-to BP Name],[Tax Classification Desc],[Max W/Tax %],[SCT Allowed],[SCT Allowed Falg],[WIT Allowed],[WIT Allowed Flag],[Warehouse Desc],[Warehouse Address Code],[Financial Company],[Enterprise unit of Wh],[Inventory Mgt Business Partner],[External Site],[External Site Flag],[Completed Delivery Flag],[On-Going Delivery Flag],[Late Orders Flag],[Product Line Levels],[Product Line First Level],[Product Line Second Level],[Product Line Third Level],[Department Desc],[Department Site],[Department Type Key],[Department Type],[Ship-to Region],[Ship-to Sub Region],[Sold-to Region],[Sold-to Sub Region],[Back Order Qty],[Original Ordered Qty],[SO Order Status],[SO Order Status Desc],
	[Ord Changed Amt],[SO Record Type],[SO Sequence Number],[SO Transaction Date],[SO Transaction Datetime],
	[Ship-to State/Province],[Ship-to City Name],[Sold-to State/Province],[Sold-to City Name],
	[Default Supply Source By Site],[Default Supply Source By Site Desc],[Delivered Value],[DWH Load Time],[Reporting Date],[Delivery Date],
	[Blocked for Inbound],[Blocked for Inbound Desc],[Blocked for Outbound],[Blocked for Outbound  Desc],
	[Ship-to Address Desc],[Sold-to Address Desc],[History Action],
	[Ship-to Latitude],[Ship-to Longitude],[Sold-to Latitude],[Sold-to Longitude],[Ship Constraint Desc],[Items Type])
	Select src_tbl.[Line Disc Amt],src_tbl.[SO Blocked],src_tbl.[Canceled],src_tbl.[Contract],src_tbl.[Cust Order],src_tbl.[Change Reason],src_tbl.[BackOrd UoM],src_tbl.[Warehouse],src_tbl.[Plnd Deliv Date],src_tbl.[Init Req Date],src_tbl.[Cust Req Date],src_tbl.[Orig Deliv Date],src_tbl.[SO Order Date],src_tbl.[Sales Lines],src_tbl.[Plnd Receipt Date],src_tbl.[Price],src_tbl.[SO Delivered Qty],src_tbl.[Ordered Qty],src_tbl.[Exch Rate Type],src_tbl.[Ship Constraint],src_tbl.[Supply-from Whs],src_tbl.[So Shipment],src_tbl.[Line Sequence],src_tbl.[Ship-to Whs],src_tbl.[Ext Sales Rep],src_tbl.[Return Reason],src_tbl.[Sales Ord Type],src_tbl.[Reference A],src_tbl.[Sales Price List],src_tbl.[Plan Deliv Date],src_tbl.[Installments],src_tbl.[Cost Serv Cont],src_tbl.[Cost FCO],src_tbl.[Cost SO Inv],src_tbl.[Activity Line],src_tbl.[Cost Goodwill],src_tbl.[Act Unit Cost],src_tbl.[Cost Quote],src_tbl.[Actual Line],src_tbl.[Cost Warranty],src_tbl.[Actual Cum Qty],src_tbl.[Actual Del Tme],src_tbl.[Total Cost],src_tbl.[Ord Disc Amt],src_tbl.[Act Purch Amt],src_tbl.[Sales Serv Con],src_tbl.[Total Disc Amt],src_tbl.[Sales FCO],src_tbl.[Sales SO Inv],src_tbl.[Sales Goodwill],src_tbl.[Sales Amt Quote],src_tbl.[Total Sales Amt],src_tbl.[Sales Warranty],src_tbl.[MC Blocked],src_tbl.[Tax Classif],src_tbl.[Delivery Terms],src_tbl.[Discount Code],src_tbl.[Carrier],src_tbl.[Cost Line Stat],src_tbl.[Company number],src_tbl.[Contr Converage],src_tbl.[Sales Price Unit],src_tbl.[Sales Qty Unit],src_tbl.[Delivery Code],src_tbl.[SO Discount],src_tbl.[Delivery Type],src_tbl.[Est Unit Cost],src_tbl.[Service Est Qty],src_tbl.[Service Est Cost Line],src_tbl.[Est Sales Price],src_tbl.[Items],src_tbl.[MC Residual Value],src_tbl.[Discount Amt],src_tbl.[Other Lines],src_tbl.[Service Order],src_tbl.[Activity],src_tbl.[Material or Maintenance Items],src_tbl.[Price Origin],src_tbl.[Sales Price],src_tbl.[PoTP],src_tbl.[Required Qty],src_tbl.[Cost Repair War],src_tbl.[Sales Repair War],src_tbl.[Repair Warranty],src_tbl.[Ship Matl To],src_tbl.[Line of Business],src_tbl.[Payment Terms],src_tbl.[Sales Rep],src_tbl.[Financial Dept],src_tbl.[Invoice-to Addr],src_tbl.[Invoice-to BP],src_tbl.[Sold-to Address],src_tbl.[Sold-to BP],src_tbl.[Payment Method],src_tbl.[Rate Type],src_tbl.[SvcO Cost Sheet],src_tbl.[Act Order Amt],src_tbl.[SOC Cancel Date],src_tbl.[Coverage Type],src_tbl.[Currency],src_tbl.[Serv Contract],src_tbl.[Service Type],src_tbl.[Service Office],src_tbl.[Est Order Amt],src_tbl.[Pricing Method],src_tbl.[Plan Start Time],src_tbl.[Warranty Type],src_tbl.[Act Cost Rate],src_tbl.[Labor Type Cost],src_tbl.[Labor Rate Code],src_tbl.[Task],src_tbl.[Service Discount],src_tbl.[Est Cost rate],src_tbl.[Labor Est Qty],src_tbl.[Sales Inv Amt],src_tbl.[Sales Inv Date],src_tbl.[Labor Type Sales],src_tbl.[Service Warranty],src_tbl.[Cost Amt War],src_tbl.[Actual Qty],src_tbl.[Cost Type],src_tbl.[Unit],src_tbl.[Est Cost Line Id],src_tbl.[Other Costs Items],src_tbl.[Act Receipt Time],src_tbl.[Maint SO],src_tbl.[Planned Carrier 1],src_tbl.[Item Delivery],src_tbl.[MO Delivered Qty],src_tbl.[Delivery Whse],src_tbl.[MO Line Status],src_tbl.[Order Discount],src_tbl.[Non SO Plan Deliv Date],src_tbl.[Plan Rec Time],src_tbl.[Qty],src_tbl.[Actual Carrier],src_tbl.[Planned Carrier 2],src_tbl.[Received Qty],src_tbl.[Shipment],src_tbl.[Receipt Whse],src_tbl.[Ship-to Address],src_tbl.[Ship-to BP],src_tbl.[Sales Type],src_tbl.[Work Order Num],src_tbl.[MO Warranty],src_tbl.[Desc],src_tbl.[Installment Plan],src_tbl.[MO Order Date],src_tbl.[MO Order Status],src_tbl.[Amt Dom Curr],src_tbl.[Net Amt],src_tbl.[Tax Code],src_tbl.[Manual Sales ID],src_tbl.[Manual Lines],src_tbl.[Financial Comp],src_tbl.[Tax Amt Dom],src_tbl.[Department],src_tbl.[Approved Amt],src_tbl.[Approval Action],src_tbl.[Approved By],src_tbl.[Approval Desci],src_tbl.[Approval Date],src_tbl.[Approval Percent],src_tbl.[Claim],src_tbl.[Claimed Amt],src_tbl.[Claim Method],src_tbl.[Appr Qty Unit],src_tbl.[Claim Qty Unit],src_tbl.[CC Residual Value],src_tbl.[Sales Doc Line],src_tbl.[Sales Doc Seq],src_tbl.[Approved Qty],src_tbl.[Claimed Qty],src_tbl.[Reject Action],src_tbl.[Rejected By],src_tbl.[Rejection Date],src_tbl.[Reject Reasons],src_tbl.[Return Matl Req],src_tbl.[CC Line Status],src_tbl.[Tagged To],src_tbl.[Wait Supp Claim],src_tbl.[CC Cancel Date],src_tbl.[Creation Date],src_tbl.[Failure Date],src_tbl.[Int Sales Rep],src_tbl.[Sales Inv Comp],src_tbl.[Sales Doc Num],src_tbl.[Sales Doc Type],src_tbl.[Sales Ref Sys],src_tbl.[Created by],src_tbl.[Order Number],src_tbl.[Order Line Numb],src_tbl.[Table Desc],src_tbl.[Table Shortcode],src_tbl.[Remain Order Qty],src_tbl.[Order Value Due],src_tbl.[NetLineAmt Dom],src_tbl.[Delivery Note],src_tbl.[Invoice Number],src_tbl.[Produc Relation],src_tbl.[Shipment Line],src_tbl.[Source Type],src_tbl.[Time of Action],src_tbl.[Inv Trans Type],src_tbl.[INV Delivered Qty],src_tbl.[Inv Line Seq],src_tbl.[Area],src_tbl.[Carrier/LSP Desc],src_tbl.[Deleted Record],src_tbl.[Carrier Alpha Code],src_tbl.[Buy-from Business Partner],src_tbl.[Transport Category],src_tbl.[Transport Category Desc],src_tbl.[Change Reason Desc],src_tbl.[Last Inventory Transaction Date],src_tbl.[Inventory Allocated],src_tbl.[Inventory Blocked],src_tbl.[Inventory Blocked for Planning],src_tbl.[Consignment Inventory Location Allocated],src_tbl.[Consignment Inventory on Hand],src_tbl.[Cumulative Issue],src_tbl.[Consignment Inventory in Transit],src_tbl.[Inventory Committed],src_tbl.[Consignment on Order],src_tbl.[Inventory Committed in Process],src_tbl.[Consigned Quarantine],src_tbl.[Goods in Transit],src_tbl.[Historical Balance],src_tbl.[Inventory on Hand],src_tbl.[Company Owned Quarantine Inventory],src_tbl.[Inventory in Transit],src_tbl.[Inventory Location Allocated],src_tbl.[Cust Owned Location Allocated],src_tbl.[Cust Owned Blocked],src_tbl.[Cust Owned Blocked for Planning],src_tbl.[Cust Owned on Hand],src_tbl.[Cust Owned in Transit],src_tbl.[Cust Owned on Order],src_tbl.[Cust Owned Quarantine],src_tbl.[Comp Owned Location Allocated],src_tbl.[Comp Owned on Order],src_tbl.[Inventory on Order],src_tbl.[Items Desc],src_tbl.[Item Group],src_tbl.[Product Class],src_tbl.[Product Line],src_tbl.[Item Signal],src_tbl.[Country of Origin],src_tbl.[Product Type],src_tbl.[Inventory Unit],src_tbl.[Serialized],src_tbl.[Default Supply Source],src_tbl.[Line of Business Desc],src_tbl.[Sales Office Desc],src_tbl.[Site],src_tbl.[Sales Order Type Desc],src_tbl.[Ship-to Address Code],src_tbl.[Ship-to Country],src_tbl.[Ship-to Country Name],src_tbl.[Ship-to BP Name],src_tbl.[Sold-to Address Code],src_tbl.[Sold-to Country],src_tbl.[Sold-to Country Name],src_tbl.[Sold-to BP Name],src_tbl.[Tax Classification Desc],src_tbl.[Max W/Tax %],src_tbl.[SCT Allowed],src_tbl.[SCT Allowed Falg],src_tbl.[WIT Allowed],src_tbl.[WIT Allowed Flag],src_tbl.[Warehouse Desc],src_tbl.[Warehouse Address Code],src_tbl.[Financial Company],src_tbl.[Enterprise unit of Wh],src_tbl.[Inventory Mgt Business Partner],src_tbl.[External Site],src_tbl.[External Site Flag],src_tbl.[Completed Delivery Flag],src_tbl.[On-Going Delivery Flag],src_tbl.[Late Orders Flag],src_tbl.[Product Line Levels],src_tbl.[Product Line First Level],src_tbl.[Product Line Second Level],src_tbl.[Product Line Third Level],src_tbl.[Department Desc],src_tbl.[Department Site],src_tbl.[Department Type Key],src_tbl.[Department Type],src_tbl.[Ship-to Region],src_tbl.[Ship-to Sub Region],src_tbl.[Sold-to Region],src_tbl.[Sold-to Sub Region],src_tbl.[Back Order Qty],src_tbl.[Original Ordered Qty],src_tbl.[SO Order Status],src_tbl.[SO Order Status Desc],src_tbl.[Ord Changed Amt],src_tbl.[SO Record Type],src_tbl.[SO Sequence Number],
	src_tbl.[SO Transaction Date],src_tbl.[SO Transaction Datetime],src_tbl.[Ship-to State/Province],src_tbl.[Ship-to City Name],
	src_tbl.[Sold-to State/Province],src_tbl.[Sold-to City Name],src_tbl.[Default Supply Source By Site],
	src_tbl.[Default Supply Source By Site Desc],src_tbl.[Delivered Value],src_tbl.[DWH Load Time],
	Case When src_tbl.[Table Shortcode] = 'SO' Then src_tbl.[SO Transaction Date] Else src_tbl.[Delivery Date] End As [Reporting Date],
	src_tbl.[Delivery Date],
	...
	src_tbl.[Ship-to Address Desc],src_tbl.[Sold-to Address Desc],src_tbl.[History Action],
...
A.[Ord Changed Amt] As [Ord Changed Amt],
A.[SO Record Type] As [SO Record Type],
A.[SO Sequence Number] As [SO Sequence Number],
A.[SO Transaction Date] As [SO Transaction Date],
A.[SO Transaction Datetime] As [SO Transaction Datetime],
A.[Site] As [Site],
A.[Delivered Value],
A.[Delivery Date],
A.[History Action],
...
FROM [replncss].[fct History Sales Revenue] A
...
) src_tbl OPTION (LABEL = '[SP_11_fct_History_Sales_Revenue_Cube_1]');
