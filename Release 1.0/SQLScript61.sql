/**********************************************************************************************************************
Table Name: [acq101].[tmp_tirpt040]
Description: This is a tmp table for Work Cells table
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tirpt040];

CREATE TABLE [acq101].[tmp_tirpt040]
 (
	bfem [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tirpt401]
Description: This is a tmp table for Production Schedule
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tirpt401];

CREATE TABLE [acq101].[tmp_tirpt401]
(
	apfd [datetime] NULL,
	apsd [datetime] NULL,
	clsd [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tirpt402]
Description: This is a tmp table for Production Schedule Lines
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tirpt402];

CREATE TABLE [acq101].[tmp_tirpt402] 
(
	apfd [datetime] NULL,
	apsd [datetime] NULL,
	compnr [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whinh200]
Description: This is a tmp table for Warehousing Orders
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_whinh200];

CREATE TABLE [acq101].[tmp_whinh200] 
(
	adat [datetime] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tirpt404]
Description: This is a tmp table for Schedule Line Distribution
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tirpt404];

CREATE TABLE [acq101].[tmp_tirpt404] 
(
	compnr [varchar](10) NULL,
	deleted [varchar](10) NULL,
	dlin [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tirpt431]
Description: This is a tmp table for Schedule Line Completions
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tirpt431];

CREATE TABLE [acq101].[tmp_tirpt431] 
(
	compnr [varchar](10) NULL,
	deleted [varchar](10) NULL,
	prsh [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tirpt200]
Description: This is a tmp table for Production Models
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tirpt200];

CREATE TABLE [acq101].[tmp_tirpt200]
(
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_whinh312]
Description: This is a tmp table for Warehouse Receipts
...
--DROP TABLE [acq101].[tmp_whinh312];

CREATE TABLE [acq101].[tmp_whinh312]
(
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_timfc001]
Description: This is a tmp table for Production Warehouse Orders
...
--DROP TABLE [acq101].[tmp_timfc001];

CREATE TABLE [acq101].[tmp_timfc001] (
	blck [int] NULL,
	blck_kw [varchar](255) NULL,
