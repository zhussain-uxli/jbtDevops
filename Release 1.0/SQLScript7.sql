/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs002]
Description: This is a dimension table for Currencies
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs002];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs002]
(
	[brep] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom000]
Description: This is a dimension table for Companies
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom000];

CREATE TABLE [dwhcda].[lnc_dim_tccom000]
(
	[acfg] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs065]
Description: This is a dimension table for Departments
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs065];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs065]
(
	[cadr] [varchar](9) NULL,
	[cadr_ref_compnr] [varchar](10) NULL,
	[casi] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs010]
Description: This is a dimension table for Countries
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs010];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs010]
(
	[afal] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom100]
Description: This is a dimension table for Business Partner
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom100]

CREATE TABLE [dwhcda].[lnc_dim_tccom100]
(
	[beid] [varchar](255) NULL,
	[bpid] [varchar](9) NULL,
	[bprl] [int] NULL,
	...
	[file_name] [varchar](100) NULL,
	[dwh_load_time] [datetime] NULL,
	[ccty] [varchar](50) NULL,
	[dsca] [varchar](100) NULL
)
WITH
(
	DISTRIBUTION = REPLICATE
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom112]
Description: This is a dimension table for Invoice_to_ Business_partners
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom112]

CREATE TABLE [dwhcda].[lnc_dim_tccom112]
(
	[adam] [float] NULL,
	[adpc] [float] NULL,
	[bicy] [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom122]
Description: This is a dimension table for Invoice-from Business partners
Data Type: Dimension Data
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom122];

CREATE TABLE [dwhcda].[lnc_dim_tccom122]
(
	[bloc] [varchar](3) NULL,
	[bpcl] [varchar](12) NULL,
	[bpcl_ref_compnr] [varchar](10) NULL,
	...
	[addr_ccty] [varchar](50) NULL,
    [addr_cste]  [varchar](50) NULL,
    [addr_dsca]  [varchar](255) NULL,
    [con_dsca] [varchar](255) NULL
)
WITH
(
	DISTRIBUTION = REPLICATE
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom110]
Description: This is a dimension table for Sold-to Business Partners
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom110]

CREATE TABLE [dwhcda].[lnc_dim_tccom110]
(
	[aalg] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom111]
Description: This is a dimension table for Ship-to Business Partners
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom111]

CREATE TABLE [dwhcda].[lnc_dim_tccom111]
(
	[aetc] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom114]
Description: This is a dimension table for Pay-by Business Partners
Data Type: Dimension Data
Original Project: JBT Finance Model
Developer: Pooja Thakur
Date: 13/07/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom114];

CREATE TABLE [dwhcda].[lnc_dim_tccom114]
(
	[aofc] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom124]
Description: This is a dimension table for Pay-to Business Partners
Data Type: Dimension Data
Original Project: JBT Finance Model
Developer: Pooja Thakur
Date: 13/07/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom124];

CREATE TABLE [dwhcda].[lnc_dim_tccom124]
(
	[aofc] [varchar](6) NULL,
	[aofc_ref_compnr] [varchar](10) NULL,
	[bank] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom120]
Description: This is a dimension table for Buy-from Business Partners
Data Type: Dimension Data
Original Project: JBT Finance Model
Developer: Pooja Thakur
Date: 13/07/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom120];

CREATE TABLE [dwhcda].[lnc_dim_tccom120]
(
	[ackx] [int] NULL,
	[ackx_kw] [varchar](255) NULL,
	[afrb] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom121]
Description: This is a dimension table for Ship-from Business Partners
Data Type: Dimension Data
Original Project: JBT Finance Model
Developer: Pooja Thakur
Date: 13/07/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom121];

CREATE TABLE [dwhcda].[lnc_dim_tccom121]
(
	[bpst] [int] NULL,
	[bpst_kw] [varchar](255) NULL,
	[cadr] [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs013]
Description: This is a dimension table for PaymentTerms
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs013];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs013]
(
	[atie] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcibd001]
Description: This is a dimension table for Items
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcibd001]

CREATE TABLE [dwhcda].[lnc_dim_tcibd001]
(
	...
	[file_name] [varchar](100) NOT NULL,
	[dwh_load_time] [datetime] NULL,
	[product_line_desc] [varchar](255) NULL,
	[product_type_desc] [varchar](255) NULL,
	[product_class_desc] [varchar](255) NULL
)
WITH
(
	DISTRIBUTION = REPLICATE
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tctax016]
Description: This is a dimension table for Tax Clasification
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tctax016];

CREATE TABLE [dwhcda].[lnc_dim_tctax016]
(
	[bpcl] [varchar](12) NULL,
	[compnr] [varchar](10) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs031]
Description: This is a dimension table for Lines_of_Business
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs031];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs031]
(
	[cbrn] [varchar](6) NULL,
	[compnr] [varchar](10) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs080]
Description: This is a dimension table for Carriers_LSP
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs080];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs080]
(
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdsls012]
Description: This is a dimension table for Sales_Office
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tdsls012];

CREATE TABLE [dwhcda].[lnc_dim_tdsls012]
(
	[cofc] [varchar](6) NULL,
	[cofc_ref_compnr] [varchar](10) NULL,
	[compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdpur012]
Description: This is a dimension table for Purchase Office
Data Type: Dimension Data
Original Project: JBT Finance Model
Developer: Pooja Thakur
Date: 13/07/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tdpur012];


CREATE TABLE [dwhcda].[lnc_dim_tdpur012]
(
	[cofc] [varchar](6) NOT NULL,
	[cofc_ref_compnr] [varchar](10) NULL,
	[compnr] [varchar](10) NOT NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs003]
Description: This is a dimension table for Warehouses
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs003];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs003]
(
	[bpid] [varchar](9) NULL,
	[cadr] [varchar](9) NULL,
	[cadr_ref_compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tccom001]
Description: This is a dimension table for Employees_General
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tccom001];

CREATE TABLE [dwhcda].[lnc_dim_tccom001]
(
	[ccal] [varchar](9) NULL,
	[ccal_ref_compnr] [varchar](10) NULL,
	[clan] [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs042]
Description: This is a dimension table for Point Of Title Passage
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs042];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs042]
(
	[cadr] [varchar](9) NULL,
	[cadr_ref_compnr] [varchar](10) NULL,
	[compnr] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs005]
Description: This is a dimension table for Reasons
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs005];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs005]
(
	[appr] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdsls094]
Description: This is a dimension table for Sales_Order_Types
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tdsls094];

CREATE TABLE [dwhcda].[lnc_dim_tdsls094]
(
	[aaps] [int] NULL,
	[aaps_kw] [varchar](255) NULL,
	[aprd] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdsls097]
Description: This is a dimension table for Change_Reasons
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tdsls097];

CREATE TABLE [dwhcda].[lnc_dim_tdsls097]
(
	[compnr] [varchar](10) NULL,
	[crcd] [varchar](6) NULL,
	[deleted] [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs202]
Description: This is a dimension table for Sales_Type
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs202];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs202]
(
	[cfrs] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs036]
Description: This is a dimension table for Tax Codes
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs036];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs036]
(
	[agtx] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs041]
Description: This is a dimension table for Delivery_Terms
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 28/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs041];

CREATE TABLE [dwhcda].[lnc_dim_tcmcs041]
(
	[cdec] [varchar](3) NULL,
	[cdyn] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tfcmg003]
Description: This is a dimension table for Payment Method
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tfcmg003];

CREATE TABLE [dwhcda].[lnc_dim_tfcmg003]
(
	[adbp] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdpct001]
...
Change History:
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tdpct001];

CREATE TABLE [dwhcda].[lnc_dim_tdpct001]
(
	[catc] [varchar](6) NULL,
	[compnr] [varchar](10) NULL,
	[ctyp] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdpct002]
...
Change History:
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tdpct002];

CREATE TABLE [dwhcda].[lnc_dim_tdpct002]
(
	[catc] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_whwmd215]
Description: This is a dimension table for Item_Inventory_by_Warehouse
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_whwmd215]

CREATE TABLE [dwhcda].[lnc_dim_whwmd215]
(
	[compnr] [varchar](10) NULL,
	[cwar] [varchar](6) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_whinr110]
Description: This is a dimension table for Items Transactions by Item and Warehouse
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 29/04/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_whinr110]

CREATE TABLE [dwhcda].[lnc_dim_whinr110]
(
	[bfbp] [varchar](9) NULL,
	[boml] [int] NULL,
	[bpid] [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcemm050]
Description: This is a dimension table for Sites
Data Type: Dimension Data
Original Project: JBT Finance Model
Developer: Pooja Thakur
Date: 13/07/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcemm050];

CREATE TABLE [dwhcda].[lnc_dim_tcemm050]
(
	[admo] [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcibd150]
Description: This is a dimension table for Item By Site
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Pooja Thakur
Date: 17/06/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcibd150];

CREATE TABLE [dwhcda].[lnc_dim_tcibd150]
(
	[ccde] [varchar](25) NULL,
	[ccde_ref_compnr] [varchar](10) NULL,
	[cean] [varchar](14) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_whwmd200]
Description: This is a dimension table for Warehouses
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_whwmd200];

CREATE TABLE [dwhcda].[lnc_dim_whwmd200]
(
	aipd [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_enum]
Description: This is a tmp table for Enum Descriptions
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [dwhcda].[lnc_dim_enum];

CREATE TABLE [dwhcda].[lnc_dim_enum]
(
	const 			[int] NOT NULL,
	deleted 		[varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tdipu081]
Description: This is a Dimension table for Item - Purchase by Site or Purchase Office
...
--DROP TABLE [dwhcda].[lnc_dim_tdipu081];

CREATE TABLE [dwhcda].[lnc_dim_tdipu081] 
(
	acci [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_cprpd100]
Description: This is a Dimension table for Items - Planning
...
--DROP TABLE [dwhcda].[lnc_dim_cprpd100];

CREATE TABLE [dwhcda].[lnc_dim_cprpd100]
(
	atho [int] NULL,
	atta [float] NULL,
	attm [float] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_country_region]
Description: This is a dimension table for Country Region Master. This is an external table which we have created and loading the file manually.
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Mohammed Majid
Date: 18/05/2021
...
Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_country_region]

CREATE TABLE [dwhcda].[lnc_dim_country_region]
(
	[name] [varchar](255) NULL,
	[alpha-2] [varchar](2) NOT NULL,
	[alpha-3] [varchar](3) NULL,
	[country-code] [int] NULL,
	[iso_3166-2] [varchar](50) NULL,
	[region] [varchar](50) NULL,
	[sub-region] [varchar](100) NULL,
	[intermediate-region] [varchar](100) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcmcs061_Ext]
Description: This is a dimension table for Product Line Master. This is an external table which we have created and loading the file manually.
Data Type: Dimension Data
Original Project: JBT Sales
Developer: Mohammed Majid
Date: 18/05/2021
Reviewed By: Atul Raje
 ...
 Change History:N/A
**********************************************************************************************************************/
--Drop Table [dwhcda].[lnc_dim_tcmcs061_Ext]

CREATE TABLE [dwhcda].[lnc_dim_tcmcs061_Ext]
(
	[compnr] [varchar](10) NOT NULL,
	[cpln] [varchar](6) NOT NULL,
	[dsca] [varchar](255) NULL,
	[levels] [int] NULL,
	[firstlevel] [varchar](100) NULL,
	[secondlevel] [varchar](100) NULL,
	[thirdlevel] [varchar](100) NULL
)
WITH
(
	DISTRIBUTION = REPLICATE
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_tcibd003]
Description: This is a Dimension table for Conversion Factors
...
--DROP TABLE [dwhcda].[lnc_dim_tcibd003];

CREATE TABLE [dwhcda].[lnc_dim_tcibd003]
(
	appr [int] NULL,
	appr_kw [varchar](255) NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_whwmd404]
...
--DROP TABLE [dwhcda].[lnc_dim_whwmd404];

CREATE TABLE [dwhcda].[lnc_dim_whwmd404] 
(
	abcc [varchar](1) NULL,
	acoa [int] NULL,
...
/**********************************************************************************************************************
Table Name: [dwhcda].[lnc_dim_whwmd216]
...
--DROP TABLE [dwhcda].[lnc_dim_whwmd216];

CREATE TABLE [dwhcda].[lnc_dim_whwmd216] 
(
	compnr [varchar](10) NOT NULL,
