/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfacr307]
Description: This is a tmp table for Account Receivable Collections by ITBP
...
Change History:N/A
**********************************************************************************************************************/
--DROP TABLE [acq101].[tmp_tfacr307];

CREATE TABLE [acq101].[tmp_tfacr307]
 (
	adfp [int] NULL,
	adod [int] NULL,
	ados [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfacr500]
Description: This is a tmp table for Account Receivable Open Items AP
...
--DROP TABLE [acq101].[tmp_tfacr500];

CREATE TABLE [acq101].[tmp_tfacr500] 
(
	adrs [varchar](9) NULL,
	amnt [float] NULL,
	amth_1 [float] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfacr601]
Description: This is a tmp table for Account Receivable Invoices/Documents by Receipt-related Documents
...
--DROP TABLE [acq101].[tmp_tfacr601];

CREATE TABLE [acq101].[tmp_tfacr601] 
(
	amnt [float] NULL,
	amti [float] NULL,
	amtl [float] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_cisli315]
Description: This is a tmp table for Account Receivable Tax Details
...
--DROP TABLE [acq101].[tmp_cisli315];

CREATE TABLE [acq101].[tmp_cisli315] 
(
	ccty [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcstl150]
Description: This is a tmp table for Account Receivable Notes
...
--DROP TABLE [acq101].[tmp_tcstl150];

CREATE TABLE [acq101].[tmp_tcstl150] (
	acty [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfacr200]
Description: This is a tmp table for Account Receivable Open Items (Sales Invoices & Receipts)
...
--DROP TABLE [acq101].[tmp_tfacr200];

CREATE TABLE [acq101].[tmp_tfacr200] 
(
	adrs [varchar](9) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfgld482]
Description: This is a tmp table for Account Receivable Integration Transactions
...
--DROP TABLE [acq101].[tmp_tfgld482];

CREATE TABLE [acq101].[tmp_tfgld482] 
(
	admm [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfgld010]
Description: This is a tmp table for Account Receivable Dimensions
...
--DROP TABLE [acq101].[tmp_tfgld010];

CREATE TABLE [acq101].[tmp_tfgld010] 
(
	atyp [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfcmg301]
Description: This is a tmp table for Account Receivable Cash Forecast
...
--DROP TABLE [acq101].[tmp_tfcmg301];

CREATE TABLE [acq101].[tmp_tfcmg301] (
	amnt [float] NULL,
	amth [float] NULL,
	bpid [varchar](9) NULL,
	bpid_ref_compnr [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcmcs008]
Description: This is a tmp table for Account Receivable Currency Rates
...
--DROP TABLE [acq101].[tmp_tcmcs008];

CREATE TABLE [acq101].[tmp_tcmcs008] (
	apdt [datetime] NULL,
	bcur [varchar](3) NULL,
