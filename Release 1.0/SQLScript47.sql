/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfgld206]
Description: This is a tmp table for GL Actual Ledger History GL Opening Balances
...
--DROP TABLE [acq101].[tmp_tfgld206];

CREATE TABLE [acq101].[tmp_tfgld206] (
	bpid [varchar](9) NULL,
	ccur [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfgld205]
Description: This is a tmp table for GL Actual Ledger History GL Transactions
...
--DROP TABLE [acq101].[tmp_tfgld205];

CREATE TABLE [acq101].[tmp_tfgld205] 
(
	bpid [varchar](9) NULL,
	ccur [varchar](3) NULL,
	ccur_ref_compnr [varchar](10) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tffbs101]
Description: This is a tmp table for GL Forecast Budget Amounts
...
--DROP TABLE [acq101].[tmp_tffbs101];

CREATE TABLE [acq101].[tmp_tffbs101] (
	amnt [float] NULL,
	back [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tffbs005]
Description: This is a tmp table for GL Forecast Budgets
...
--DROP TABLE [acq101].[tmp_tffbs005];

CREATE TABLE [acq101].[tmp_tffbs005] (
	budg [varchar](3) NULL,
	budg_ref_compnr [varchar](10) NULL,
	cbud [varchar](3) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tffbs003]
Description: This is a tmp table for GL Forecast Budget Master
...
--DROP TABLE [acq101].[tmp_tffbs003];

CREATE TABLE [acq101].[tmp_tffbs003] (
	ad10 [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfgld106]
Description: This is a tmp table for GL Actual Finalized Transactions
...
--DROP TABLE [acq101].[tmp_tfgld106];

CREATE TABLE [acq101].[tmp_tfgld106] (
	adty [int] NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tfgld008]
Description: This is a tmp table for GL Chart of Accounts
...
--DROP TABLE [acq101].[tmp_tfgld008];

CREATE TABLE [acq101].[tmp_tfgld008] (
	acmp [varchar](8) NULL,
...
/**********************************************************************************************************************
Table Name: [acq101].[tmp_tcemm170]
Description: This is a tmp table for GL Companies
...
--DROP TABLE [acq101].[tmp_tcemm170];

CREATE TABLE [acq101].[tmp_tcemm170] (
	ccal [varchar](9) NULL,
